/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e082b6800a57e6efa64c59679b03ea66)
...
interface __BaseEnv_Env {
	...
	AI: Ai;
	ASSETS: Fetcher;
	RENDER_SERVICE_URL: "https://cra-rbm-assistant.onrender.com";
	KONECT_FALLBACK_TOKEN: string;
	CraAssistantAgent: DurableObjectNamespace<import("./worker/index").CraAssistantAgent>;
	RegulatoryRAGAgent: DurableObjectNamespace<import("./worker/index").RegulatoryRAGAgent>;
	REGULATORY_BRIEFING_WORKFLOW: Workflow<Parameters<import("./worker/index").RegulatoryBriefingWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "CraAssistantAgent" | "RegulatoryRAGAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RENDER_SERVICE_URL" | "KONECT_FALLBACK_TOKEN">> {}
}
